<form method="get">
    ...
    <div class="mb-3">
        <label for="cost" class="form-label">Фильтрация по названию</label>
    ...
    <div class="mb-3">
        <label for="cost" class="form-label">Фильтрация по автору</label>
    ...
    <div class="mb-3">
        <label for="cost" class="form-label">Фильтрация по описанию</label>
